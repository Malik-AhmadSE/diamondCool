...
function Brands() {
  return (
  <div className="md:!w-full flex-col mt-8 items-center justify-center mb-7">
    ...
    <div className="flex flex-row items-center gap-10">
      <Tooltip title="Buy from noon">
        <a href='https://www.noon.com/seller/p-149548/?offer_code=ze536cca4ff792a1163e9z-1&sku=ZE536CCA4FF792A1163E9Z'>
          <Image alt='img' src={Pic} preview={false} className='md:!w-[270px] mt-1 !w-[170px]' />
        </a>
      </Tooltip>
      ...
      <Carousel autoplay speed={200} className="!w-screen p-[15px]" >
        {imageUrls.map((url, index) => (
          <div key={index} className="w-full md:h-56 flex items-center justify-center">
            <img
              src={url}
              alt={`Image ${index + 1}`}
              className="md:!w-[96.7%] w-full md:h-full h-[100px] object-contain"
              style={{ display: 'block' }}
            />
          </div>
        ))}
