  ...
  return (
    <>
      {loading ? (
        ...
        <Image src={'https://res.cloudinary.com/dvf9mmcww/image/upload/v1728178665/22_vmd5cw.png'} preview={false} className='!w-full mt-10 md:mt-44 z-0 !h-[320px] md:!h-[600px] flex flex-col justify-center items-center px-4' />
      )}
    </>
  );
}
