    ...
    return (
        <>
            <div className='w-full flex flex-col md:flex-row gap-2'>
                <div className='w-full md:w-[60%] z-1 flex flex-col pl-10 gap-2'>
                    <h6 className='font-semibold mb-2'>Reach Us</h6>
                    <h1 className='w-full md:w-[550px] font-bold text-[45px]'>Contact us</h1>
                ...
                <div className='w-full md:w-[40%] pl-10 md:pt-0 pt-5 flex justify-center items-center'>
