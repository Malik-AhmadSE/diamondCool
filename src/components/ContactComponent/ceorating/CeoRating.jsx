    ...
    return (
        <div className='w-full md:px-8 px-4 flex flex-col justify-center items-center text-center'>
            ...
            <h1 ref={headingRef} className='w-full md:w-[900px] font-bold md:text-[45px] text-[25px]'>
                At Diamond Cool, we deliver high-quality spare parts  Air conditions, Refrigerators, Washing Machines and Tools ensuring your appliances run smoothly and reliably.
            </h1>
