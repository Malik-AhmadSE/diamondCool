    ...
    return (
        <div className='w-full md:px-8 px-4 flex justify-center items-center mb-10 mt-10'>
            <div className='w-full flex flex-col'>
                ...
                <Button 
                    type={btn} 
                    onMouseEnter={() => setbtn('primary')} 
                    className='bg-transparent w-24 pt-4 pb-4 pl-5 pr-5 mt-5 font-semibold text-green-700 border hover:!bg-black hover:border hover:border-black border-green-700 hover:text-white'
                >
                    Contact
                </Button>
            </div>
