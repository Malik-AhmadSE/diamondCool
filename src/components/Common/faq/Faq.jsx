...
function Faq() {
  ...
  return (
    <div className='flex flex-col pl-10'>
        ...
        <h1 className='w-[550px] font-bold text-[45px]'>FAQ's</h1>
        <p className='w-[620px] pt-5 tracking-wider'>Find answers to common questions about our products and services right here.</p>
        </div>
        <div className='pt-10 w-full flex gap-16 flex-wrap'>
        <div className='w-[45%] flex gap-5 flex-wrap'>
            <div>
             <h5 className='w-[550px] font-bold text-[20px]'>What products do you offer?</h5>
            ...
            <div>
             <h5 className='w-[550px] font-bold text-[20px]'>What is your warranty?</h5>
            ...
            <div>
             <h5 className='w-[550px] font-bold text-[20px]'>Where are you located?</h5>
        ...
        <div className='w-[45%] flex gap-5 flex-wrap'>
            <div>
             <h5 className='w-[550px] font-bold text-[20px]'>How can I contact you?</h5>
            ...
            <div>
             <h5 className='w-[550px] font-bold text-[20px]'>Do you offer repairs?</h5>
        ...
        <h1 className='w-[550px] font-bold text-[45px]'>Still have questions?</h1>
        <p className='w-[620px] pt-5 tracking-wider'>We're here to help you with any inquiries.</p>
        </div> 
