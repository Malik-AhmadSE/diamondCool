...
function Expertise() {
    return (
        <div className='w-full mt-36 z-1 flex gap-3 items-center flex-wrap'>
            <div className='pl-10 w-full md:w-auto'>
                <h1 className='md:w-[550px] font-bold text-[45px]'>Expertise that Keeps Your Machines in Optimal Condition</h1>
