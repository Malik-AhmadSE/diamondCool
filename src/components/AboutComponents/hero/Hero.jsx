        ...
        <div ref={containerRef} className='w-full md:px-8 px-4 mt-32 md:mt-44 flex justify-center items-center'>
           <div className='w-full z-1 flex gap-6 flex-wrap md:flex-nowrap'>
                <div className='w-full md:w-[600px]' ref={titleRef}>
                    <h1 className='font-bold text-justify text-[32px] md:text-[45px] leading-tight  md:text-left'>
                ...
                <div className='w-full md:w-[45%] md:pl-10 flex flex-col justify-center items-center md:items-start'>
                    <p ref={contentRef} className='pt-5 tracking-wider text-justify  text-base md:text-lg'>
                        Welcome to Diamond Cool, your trusted partner for high-quality spare parts for  Air conditions Spare Parts, Refrigerators Spare Parts, Washing Machines Spare Parts. We are dedicated to providing reliable, durable, and affordable solutions for all your home appliance needs.
                    </p>
